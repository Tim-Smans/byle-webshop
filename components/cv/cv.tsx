          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="relative bg-muted/30 border border-border/40 rounded-[2rem] p-10">
              ...
              <p className="text-lg leading-relaxed text-muted-foreground">
                ...
                gelaagdheid, organische vormen en subtiele metallic
                afwerkingen.
              </p>
            </div>
            ...
            <div className="relative bg-muted/30 border border-border/40 rounded-[2rem] p-10">
              ...
              <div className="flex flex-wrap gap-3">
                {mediums.map((medium) => (
                  <div
                    key={medium}
                    className="px-4 py-2 rounded-full bg-background border border-border/50 text-muted-foreground"
                  >
                    {medium}
                  </div>
                ))}
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-10">
                ...
                <div>
                  ...
                  <h2 className="text-4xl text-oker font-light">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-5">
                {themes.map((theme) => (
                  <div
                    key={theme}
                    className="group rounded-2xl border border-border/40 bg-background/70 p-6 transition-all duration-300 hover:-translate-y-1"
                  >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="rounded-[2rem] border border-border/40 bg-muted/20 p-10">
              ...
              <div className="space-y-4 text-muted-foreground text-lg">
                ...
                <div className="pt-4 border-t border-border/40">
                  <p className="text-5xl text-oker font-light mb-2">4</p>
            ...
            <div className="rounded-[2rem] border border-border/40 bg-muted/20 p-10">
              ...
              <div className="space-y-5">
                <div className="border-l border-secondary/40 pl-5">
